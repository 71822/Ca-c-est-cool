...
async function getMultiplePosts() {
  if(tokenVerif){
    //SELECT poste.id, poste.title, poste.contenu, poste.pouce, poste.imagePost, poste.createdAt, poste.id_1, membre.nom, membre.prenom FROM poste, membre ORDER BY poste.id DESC
